package com.example.loading_animations_android
...
import com.example.loading_animations_android.ui.theme.Loading_Animations_AndroidTheme
...
private fun BlurredAnimatedTextPreview(){
    Loading_Animations_AndroidTheme {
        BlurredAnimatedText(
            text = "Your progress is loading...",
            modifier = Modifier
        )
    }
}
